...
The public timeline of the proof build. Entries are sanitized: dates, milestones, and corrections, without implementation detail. New entries land when there is something real, never to look busy.

## 2026-08-26
Substrate started. Dedicated deployment stood up with the v0 server baseline: firewall, intrusion lockout, automatic security updates, database bound to localhost, nightly local dumps.

## 2026-09-09
Gate boundaries proven, 55 of 55. First run scored 53 of 55; both failures were assertion-format bugs in the test script, not boundary breaches. Patched under review, rerun clean. Same evening: canonical truth seeded, 47 records of 47, every one through proposal and human promotion in atomic transactions.
